...
const Product = ({post}) => {
  ...
  return(
    <div className="flex flex-col items-center justify-between hover:scale-110 transition duration-500 ease-in gap-3 p-4 mt-10 ml-5 rounded-xl outline  ">
        <div>
        ...
        {
          cart.some((p) => p.id == post.id) ? (<button onClick={removecart}
